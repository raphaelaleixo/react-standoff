...
export function TargetingMap({ game, dim, overlay }: TargetingMapProps) {
  ...
  // card between reveal_others and split.
  const FROM_WITHDRAW_REVEAL = new Set([
    "reveal_withdraw", "reveal_bbb",
    "reveal_others", "tough_reveal", "split", "grenade",
  ]);
    ...
    >
      ...
      >
        ...
        {showLines && (() => {
          ...
          // join at reveal_others. Once fired, stays fired through
          // tough_reveal so the visual doesn't snap back to beige between
          // reveals.
