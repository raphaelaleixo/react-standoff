...
// Coastal-lookout lantern. Off-state is a dim outline; on-state is a
// warm gold glow with a soft halo. Used by the Switchboard widget to
// signal the cop's bottles washing ashore — 3 lanterns lit = the
// Navy is on its way.
//
...
const LIT_COLOR = "#f6c66a";
const UNLIT_COLOR = "rgba(255, 255, 255, 0.22)";
  ...
  return (
    <Box
      sx={{
        ...
        lineHeight: 0,
        color: lit ? LIT_COLOR : UNLIT_COLOR,
        filter: lit ? `drop-shadow(0 0 10px ${LIT_COLOR}aa)` : undefined,
    ...
    >
      <svg viewBox={VIEW_BOX} xmlns="http://www.w3.org/2000/svg" width="100%">
        <g transform={LANTERN_TRANSFORM}>
          <path d={LANTERN_D} fill="currentColor" fillRule="nonzero" />
        </g>
      </svg>
    </Box>
  );
