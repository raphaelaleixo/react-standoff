// Praying hands — the centred sigil for Yellow-Belly's Purse
// (Super Coward). Multi-path woodcut feel; uses `currentColor`
// so the host context controls the fill.
// Source artwork: https://www.svgrepo.com/show/281017/pray.svg (CC0).
export function PrayingHands({ size = 64 }: { size?: number | string }) {
  return (
    <svg
      viewBox="0 0 512 512"
      width={size}
    ...
    >
      <g fill="currentColor">
        ...
        <rect x="25.869" y="14.007" transform="matrix(0.3333 -0.9428 0.9428 0.3333 -12.1164 70.412)" width="35.72" height="59.534" />
        <rect x="452.465" y="107.281" width="59.535" height="35.721" />
        <rect x="438.486" y="25.919" transform="matrix(0.9428 -0.3333 0.3333 0.9428 12.1837 158.5749)" width="59.533" height="35.719" />
      </g>
    </svg>
  );
}
