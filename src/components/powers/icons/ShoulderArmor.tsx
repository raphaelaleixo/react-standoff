// Shoulder armour / pauldron — the centred sigil for Krakenscale
// (Dragon Skin). Single compound path, woodcut feel; uses `currentColor`
// so the host context controls the fill.
// Source artwork: https://www.svgrepo.com/show/323239/shoulder-armor.svg (CC0).
export function ShoulderArmor({ size = 64 }: { size?: number | string }) {
  return (
    <svg
      viewBox="0 0 512 512"
      width={size}
